...
| `VERCEL_TURSO_TURSO_DATABASE_URL` | e.g. `libsql://<db>-<org>.turso.io` - injected by the Turso Vercel Marketplace integration |
| `VERCEL_TURSO_TURSO_AUTH_TOKEN` | Turso auth token - injected by the Turso Vercel Marketplace integration |
...
export VERCEL_TURSO_TURSO_DATABASE_URL=libsql://...
export VERCEL_TURSO_TURSO_AUTH_TOKEN=...
