...
| `TURSO_DATABASE_URL` | e.g. `libsql://<db>-<org>.turso.io` - injected by the Turso Vercel Marketplace integration |
| `TURSO_AUTH_TOKEN` | Turso auth token - injected by the Turso Vercel Marketplace integration |
