...
class LichessDailyPuzzle:
    def __init__(self):
        self.LICHESS_OAUTH_TOKEN = os.environ['LICHESS_APP_OAUTH_TOKEN']
    ...
    def handle_puzzle_generation_and_sending(self) -> None:
...
if __name__ == "__main__":
    obj=LichessDailyPuzzle()
    obj.handle_puzzle_generation_and_sending()