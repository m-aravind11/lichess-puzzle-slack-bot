...
def test_force_query_param_is_passed_through(client, monkeypatch):
    ...
    response = client.post(
        "/admin/dailyPuzzle:send", params={"force": "true"}, headers={"Authorization": "Bearer s3cr3t"},
    )
...
def test_new_puzzle_query_param_is_passed_through(client, monkeypatch):
    ...
    response = client.post(
        "/admin/dailyPuzzle:send", params={"newPuzzle": "true"}, headers={"Authorization": "Bearer s3cr3t"},
    )
...
def test_both_query_params_are_passed_through(client, monkeypatch):
    ...
    response = client.post(
        "/admin/dailyPuzzle:send",
        params={"force": "true", "newPuzzle": "true"},
